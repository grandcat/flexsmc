...
func (SMCCmd_Phase) EnumDescriptor() ([]byte, []int) { return fileDescriptor0, []int{5, 0} }
...
func (CmdResult_Status) EnumDescriptor() ([]byte, []int) { return fileDescriptor0, []int{6, 0} }
...
func (*SessionPhase) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{3} }
...
func (*DebugPhase) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{4} }
...
func (*SMCCmd) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{5} }
...
func (*CmdResult) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{6} }
...
func (*SMCResult) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{7} }
...
var fileDescriptor0 = []byte{
	...
	,
}
